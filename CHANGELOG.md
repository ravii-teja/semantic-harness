...
### Added
- **Real LLM Provider Adapters**: Direct `OpenAIProvider`, `AnthropicProvider`, and zero-dependency `OllamaProvider`.
- **Provider Factory**: `get_provider()` with automatic provider routing from model name strings.
